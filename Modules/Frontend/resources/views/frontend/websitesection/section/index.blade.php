                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <a href="{{ route('app-overview.create') }}" class="float-end btn btn-sm btn-primary">
                                <i class="fa fa-plus-circle"></i>
                                {{ __('message.add_form_title', ['form' => __('frontend::message.section')]) }}
                            </a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('app-overview.edit', $section->id) }}" class="mr-2" data-toggle="tooltip" title="{{ __('message.update_form_title', ['form' => __('frontend::message.section')]) }}">
                                                ...
                                                {{ html()->form('DELETE', route('app-overview.destroy', $section->id))->attribute('data--submit', 'websection' . $section->id)->open() }}
                                                    <a href="javascript:void(0)" class="text-danger" data--submit="websection{{ $section->id }}" data-toggle="tooltip"
                                                       ...
                                                       data-title="{{ __('message.delete_form_title', ['form' => __('frontend::message.section')]) }}"
                                                       title="{{ __('message.delete_form_title', ['form' => __('frontend::message.section')]) }}"
