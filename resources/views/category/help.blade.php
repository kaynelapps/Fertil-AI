        ...
        <div class="modal-body">
            <div class="col-md-12">
                <div class="form-group">
                    <div>
                        <h5>{{ __('message.help_section_title_one') }} <span class="font-weight-bold">"{{ __('message.help_form_title',['form' => __('message.category')]) }}" </span>{{ __('message.help_section_title_two') }}</h5>
                    </div>
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="">
                                    <li class="mt-2">{{ __('message.help_section_title_four') }} <span class="font-weight-bold">"{{ __('message.help_form_title',['form' => __('message.category')]) }}" </span> {{ __('message.help_section_title_five') }}</li>
