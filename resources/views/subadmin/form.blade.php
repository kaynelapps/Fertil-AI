                        ...
                        <div class="form-group mt-3">
                            <div class="grid" style="--bs-gap: 1rem">
                                ...
                                {{ html()->select('user_type', $roles, old('user_type'))
                                    ...
                                    ->attribute('data-placeholder', __('message.select_name', ['select' => __('message.role')]))->required()
                                }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ html()->text('last_name', $data->last_name ?? old('last_name'))->placeholder(__('message.last_name'))->class('form-control')->required() }}
                                </div>

                                <div class="form-group col-md-6">
                                    {{ html()->label(__('message.email') . ' <span class="text-danger">*</span>', 'email')->class('form-control-label') }}
                                    {{ html()->email('email', $data->email ?? old('email'))->placeholder(__('message.email'))->class('form-control')->required()->attributeIf(isset($id), 'readonly', 'readonly') }}
                                </div>
