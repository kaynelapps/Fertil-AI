                ...
                <div class="card">
                    <div class="card-header1 d-flex justify-content-between mt-3 ml-3">
                        ...
                        <div class="card-action mr-2 mb-2">
                            <a href="{{ route('section-help') }}" class="btn btn-sm loadRemoteModel mr-3 help" role="button">{{ __('message.help') }}</a>
                            <a href="{{ route('templateinfosection.excel') }}" class="btn btn-md  mr-3 ml-3 btn-success" role="button">
                            <i class="fas fa-file-download mr-2"></i>{{ __('message.download') }}</a>
                        </div>
                    </div>
                    {{ html()->form('POST', route('import.infosection'))->attribute('enctype','multipart/form-data')->id('uploadForm')->open() }}
                        <div class="card-body">
