                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a href="{{ route('users.show', $data->id) }}" class="nav-link {{ $type == 'profile' ? 'active': '' }}"> {{ __('message.profile') }} </a>
                            </li>
                        </ul>
                                            ...
                                            <div class="profile-box">
                                                ...
                                                <div class="pro-content rounded">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <p class="mb-0">
                                                            {{ __('message.app_source') }} :
                                                                <span style="display: inline-block; word-break: break-all;">
                                                            {{ auth()->user()->hasAnyRole(['admin', 'super_admin']) ? ($data->app_source ?: 'N/A') : 'N/A' }}
                                                            </span>
                                                        </p>
                                                    </div>
                                                    <div class="d-flex align-items-center mb-3">
