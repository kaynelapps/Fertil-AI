...
<div class="modal-dialog modal-fullscreen-right" role="document">
    <div class="modal-content">
        <div class="modal-header">
           ...
           {!! html()->form('GET', route('customtopic.search', $id))->id('filter-form')->open() !!}
        ...
        <div class="modal-footer">
            ...
            <a href="{{ route('customtopic.search',$id) }}" class="btn btn-orange btn-sm" title="{{ __('message.reset_filter') }}">
