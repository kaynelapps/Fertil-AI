...
{{ html()->hidden('id', null, array('placeholder' => 'id','class' => 'form-control')) }}
{{ html()->hidden('page', $page, array('placeholder' => 'id','class' => 'form-control')) }}
<div class="row">
    <div class="col-lg-6"> 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                {{ html()->text('contact_email', null)->class('form-control')->placeholder(__('message.contact_email')) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                {{ html()->text('contact_number', null)->class('form-control')->placeholder(__('message.contact_number')) }}
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group col-md-12">
            {{ html()->label( __('message.theme_color'))->for('bg_color_code')->class('form-control-label') }}
            <div class="input-group">
                {{ html()->input('color', 'bg_color', $settings->color ?? '#fe5783')->class('form-control form-control-color')->id('bg_color_picker')->attribute('title', __('message.theme_color'))->required() }}
                {{ html()->text('color', $settings->color ?? '#fe5783')->placeholder(__('message.bg_color'))->class('form-control')->id('bg_color_code')->required() }}
            </div>
        </div>
        ...
        <div class="form-group">
            {{ html()->label(__('message.facebook_url'))->for('facebook_url')->class('col-sm-6  form-control-label') }}
            <div class="col-sm-12">
                {{ html()->text('facebook_ur', null)->class('form-control')->placeholder(__('message.enter_name', [ 'name' => __('message.facebook_url') ])) }}
            </div>
        </div>
        <div class="form-group">
            {{ html()->label(__('message.twitter_url'))->for('twitter_url')->class('col-sm-6  form-control-label') }}
            <div class="col-sm-12">
        ...
        <div class="form-group">
            {{ html()->label(__('message.linkedin_url'))->for('linkedin_url')->class('col-sm-6  form-control-label') }}
            <div class="col-sm-12">
        ...
        <div class="form-group">
            {{ html()->label(__('message.instagram_url'))->for('instagram_url')->class('col-sm-6  form-control-label') }}
            <div class="col-sm-12">
        ...
        <div class="form-group">
            {{ html()->label(__('message.copyright_text'))->for('copyright_text')->class('col-sm-6  form-control-label') }}
            <div class="col-sm-12">
                {{ html()->text('site_copyright', null)->class('form-control')->placeholder(__('message.enter_name', [ 'name' => __('message.site_copyright') ])) }}
            </div>
        </div>
        <div class="form-group">
            {{ html()->label(__('message.help_support_url'))->for('help_support_url')->class('col-sm-6  form-control-label') }}
            <div class="col-sm-12">
