                    ...
                    {{ html()->modelForm($setting_data, 'POST', route('term-condition-save'))->attribute('data-toggle', 'validator')->open() }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                {{ html()->label(__('message.terms_condition'), 'terms_condition')->class('form-control-label') }}

                                {{ html()->textarea('value')->class('form-control tinymce-description')->placeholder(__('message.terms_condition')) }}
                            </div>
                        </div>
