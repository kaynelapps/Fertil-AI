...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                {{ html()->textarea('description')->class('form-control')->placeholder(__('message.description')) }}
            </div>
        </div>
    </div>
    <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                   <div class="custom-file col-md-12">
                        {{ html()->file('app_image')->class('custom-file-input custom-file-input-sm detail')->id('app_image')->attribute('lang', 'en')->accept('image/*') }}
