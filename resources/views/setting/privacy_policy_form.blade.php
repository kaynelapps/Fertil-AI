                    ...
                    {{ html()->modelForm($setting_data, 'POST', route('privacy-policy-save'))->attribute('data-toggle', 'validator')->open() }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                {{ html()->label(__('message.privacy_policy'), 'privacy_policy')->class('form-control-label') }}

                                {{ html()->textarea('value')->class('form-control tinymce-description')->placeholder(__('message.privacy_policy')) }}
                            </div>
                        </div>
