<x-master-layout :assets="$assets ?? []">
    <div>
        <?php $id = $id ?? null;?>
        @if(isset($id))
            {{ html()->modelForm($data, 'PATCH', route('anonymoususer.update', $id))->attribute('enctype', 'multipart/form-data')->open() }}
        @else
            {{ html()->form('POST', route('anonymoususer.store'))->attribute('enctype','multipart/form-data')->open() }}  
        @endif
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h5 class="card-title">{{ $pageTitle }} {{ __('message.information') }}</h5>
                        </div>
                        ...
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ html()->email('email', old('email'))->placeholder(__('message.email'))->class('form-control')->attribute($id ? 'readonly' : '') }}
                                </div>
                                <div class="form-group col-md-6">
