...
<div class="modal-dialog modal-fullscreen-right" role="document">
    <div class="modal-content">
        ...
        {{ html()->form('GET', route('personalinsights.index'))->id('filter-form')->open() }}
        ...
        <div class="modal-footer">
            ...
            <a href="{{ route('personalinsights.index') }}" class="btn btn-orange btn-sm" title="{{ __('message.reset_filter') }}">
