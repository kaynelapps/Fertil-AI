...
<div class="modal-dialog modal-fullscreen-right" role="document">
    <div class="modal-content">
        <div class="modal-header">
         ...
         {{ html()->form('GET', route('common-question.index'))->id('filter-form')->open() }}
        ...
        <div class="modal-footer">
            ...
            <a href="{{ route('common-question.index') }}" class="btn btn-orange btn-sm" title="{{ __('message.reset_filter') }}">
