                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon dropdown">
                            <a href="javascript:void(0);" class="search-toggle dropdown-toggle notification_list" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="javascript:void(0);" class="search-toggle dropdown-toggle" id="languageDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @php
                        ...
                        <li class="nav-item nav-icon dropdown full-screen">
                            <a href="javascript:void(0);" class="nav-item nav-icon dropdown" id="btnFullscreen">
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="javascript:void(0);" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                <img src="{{ auth()->user()->hasRole('doctor') ? getSingleMedia( optional(auth()->user()->health_expert), 'health_experts_image', null) : getSingleMedia( auth()->user(), 'profile_image', null) }}" class="img-fluid avatar-rounded" alt="user">
                            </a>
