...
<div class="modal-dialog modal-fullscreen-right" role="document">
    <div class="modal-content">
        <div class="modal-header">
           ...
           {!! html()->form('GET', route('section-data-main.show', $id))->id('filter-form')->open() !!}
        <div class="modal-body">
            <div class="form-group col-md-12">
                {{ html()->label(__('message.view_type') . ' <span class="text-danger">*</span>', 'view_type')->class('form-control-label') }}
                {{ html()->select('view_type', ['' => ''] + getViewType(), $params['view_type'] ?? old('view_type'))
        ...
        <div class="modal-footer">
            ...
            <a href="{{ route('section-data-main.show',$id) }}" class="btn btn-orange btn-sm" title="{{ __('message.reset_filter') }}">
