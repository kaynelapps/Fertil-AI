...
class AnonymousUserDataTable extends DataTable
{
    use DataTableTrait;
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('name', function ($user) {
                ...
                $url = route('anonymoususer.show', $user->id);
            ...
            ->editColumn('status', function($data) {
                $action_type = 'status';
                $deleted_at = null;
                return view('anonymous_user.action',compact('data','action_type','deleted_at'))->render();
            })
            ...
            ->addColumn('action', function($users){
                ...
                return view('anonymous_user.action',compact('users','action_type','id','deleted_at'))->render();
            })
            ->addIndexColumn()
    ...
    {
        $model = User::where('user_type','anonymous_user');
