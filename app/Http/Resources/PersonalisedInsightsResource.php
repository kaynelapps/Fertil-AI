...
class PersonalisedInsightsResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'personalinsights_data' => json_decode($this->personalinsights_data, true) ?? null,
