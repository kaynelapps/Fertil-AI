...
class PermissionController extends Controller
{
    ...
    {
        $permission = Permission::orderBy('id','ASC')->whereNotIn('name',['app_user', 'anonymous_user'])->whereNull('parent_id')->with('subpermission')->get();
        $pageTitle = __('message.list_form_title',['form' => __('message.permission')  ]);

        $roles = Role::where('status',1)->whereNotIn('name',['app_user','anonymous_user'])->orderBy('name','ASC');
    ...
    public function savePermission(Request $request)
    {
        ...
        $message = __('message.save_form', ['form' => __('message.'.$data['type'])]);
