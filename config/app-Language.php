    ...
    'SCREEN_DATA' => [
        ...
        [
            ...
            [
                "screen_id"=> "5",
                "keyword_id"=> 562,
                "keyword_name"=> "ReportForADoctor",
                "keyword_value"=> "Report for a Doctor"
            ],
            [
                "screen_id"=> "5",
                "keyword_id"=> 563,
                "keyword_name"=> "ShareYourSymptoms",
                "keyword_value"=> "Share your symptoms, moods, flow and more with your doctor!"
            ],
            [
                "screen_id"=> "5",
                "keyword_id"=> 564,
                "keyword_name"=> "MenstrualReport",
                "keyword_value"=> "Menstrual Report"
            ],
            [
                "screen_id"=> "5",
                "keyword_id"=> 612,
                "keyword_name"=> "Highlights",
                "keyword_value"=> "Highlights"
            ],
            [
                "screen_id"=> "5",
                "keyword_id"=> 613,
                "keyword_name"=> "EstrogenProgesterone",
                "keyword_value"=> "Estrogen/Progesterone"
            ]
            ]
        ],
        [
            "screen_id"=> "6",
            "screen_name"=> "graphAndReports",
            "keyword_data"=> [
            [
                "screen_id"=> "6",
                "keyword_id"=> 53,
        ...
        [
            ...
            [
                ...
                "keyword_value"=> "Cycle Reminder"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 67,
                "keyword_name"=> "medicineReminders",
                "keyword_value"=> "Medicine Reminder"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 68,
                "keyword_name"=> "meditationReminders",
                "keyword_value"=> "Meditation Reminder"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 470,
            ...
            [
                ...
                "keyword_value"=> "Daily Logging Reminder"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 71,
                "keyword_name"=> "trackingReminders",
                "keyword_value"=> "Tracking Reminder"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 72,
                "keyword_name"=> "secretReminders",
                "keyword_value"=> "Secret Reminder"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 73,
            ...
            [
                "screen_id"=> "7",
                "keyword_id"=> 565,
                "keyword_name"=> "TimeToTakeYourMedicine",
                "keyword_value"=> "Time to take your medicine. Consistency is key to your well-being."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 566,
                "keyword_name"=> "PrioritizeMindfulnessAndRelaxationWithDailyMeditationReminders",
                "keyword_value"=> "Prioritize mindfulness and relaxation with daily meditation reminders."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 567,
                "keyword_name"=> "TakeAMindfulBreak",
                "keyword_value"=> "Take a mindful break. Breathe, relax, and reset with a few minutes of meditation."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 568,
                "keyword_name"=> "ItTimeToLogYourDay",
                "keyword_value"=> "It’s time to log your day. Keep track of your progress and emotions."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 569,
                "keyword_name"=> "TrackYourProgressToday",
                "keyword_value"=> "Track your progress today!"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 570,
                "keyword_name"=> "TrackYourWeightRegularly",
                "keyword_value"=> "Track your weight regularly to monitor your fitness and health goals."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 571,
                "keyword_name"=> "DoNotForgetToLogYourWeightToday",
                "keyword_value"=> "Don't forget to log your weight today. Every small step counts!"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 572,
                "keyword_name"=> "StayHydratedThroughout",
                "keyword_value"=> "Stay hydrated throughout the day with timely water reminders to boost your health and energy"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 573,
                "keyword_name"=> "StayHydratedDrinkWater",
                "keyword_value"=> "Stay hydrated, drink water!"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 574,
                "keyword_name"=> "WindDownAndGetEnoughRest",
                "keyword_value"=> "Wind down and get enough rest with a gentle bedtime reminder."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 575,
                "keyword_name"=> "PrepareForAGood",
                "keyword_value"=> "Prepare for a good night’s sleep. Rest well and recharge."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 576,
                "keyword_name"=> "LogYourBasalBodyTemperature",
                "keyword_value"=> "Log your basal body temperature daily to better understand your cycle and health."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 577,
                "keyword_name"=> "TimeToRecordYourBodyTemperature",
                "keyword_value"=> "Time to record your body temperature. Small insights, big impact."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 578,
            ...
            [
                "screen_id"=> "7",
                "keyword_id"=> 580,
                "keyword_name"=> "YourPeriodIsExpectedSoon",
                "keyword_value"=> "Your period is expected soon. Stay ready and take care of yourself."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 581,
                "keyword_name"=> "YouAreEntering",
                "keyword_value"=> "You're entering your ovulation window. Tune into your body today."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 582,
                "keyword_name"=> "GetTimelyAlerts",
                "keyword_value"=> "Get timely alerts to track your period and stay prepared."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 583,
                "keyword_name"=> "StayInformedAbout",
                "keyword_value"=> "Stay informed about your fertile window for better cycle and pregnancy tracking."
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 584,
                "keyword_name"=> "isSet",
                "keyword_value"=> "is set"
            ],
            [
                "screen_id"=> "7",
                "keyword_id"=> 585,
        ...
        [
            "screen_id"=> "8",
            "screen_name"=> "periodPredictionScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "8",
                "keyword_id"=> 95,
        ...
        [
            "screen_id"=> "10",
            "screen_name"=> "cycleRemindersScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "10",
                "keyword_id"=> 103,
                "keyword_name"=> "periodReminders",
                "keyword_value"=> "Period Reminder"
            ],
            [
                "screen_id"=> "10",
                "keyword_id"=> 104,
        ...
        [
            "screen_id"=> "11",
            "screen_name"=> "medicineReminderScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "11",
                "keyword_id"=> 109,
        ...
        [
            "screen_id"=> "12",
            "screen_name"=> "meditationReminderScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "12",
                "keyword_id"=> 111,
        ...
        [
            "screen_id"=> "13",
            "screen_name"=> "dailyLoggingScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "13",
                "keyword_id"=> 113,
        ...
        [
            "screen_id"=> "15",
            "screen_name"=> "secretReminderScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "15",
                "keyword_id"=> 117,
        ...
        [
            "screen_id"=> "16",
            "screen_name"=> "yourNamePopUpScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "16",
                "keyword_id"=> 123,
        ...
        [
            "screen_id"=> "17",
            "screen_name"=> "secureAccessPinScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "17",
                "keyword_id"=> 124,
        ...
        [
            "screen_id"=> "21",
            "screen_name"=> "calculatorToolsScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "21",
                "keyword_id"=> 134,
        ...
        [
            "screen_id"=> "22",
            "screen_name"=> "calculatorCommonScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "22",
                "keyword_id"=> 140,
        ...
        [
            "screen_id"=> "35",
            "screen_name"=> "DoctorProfileOverviewScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "35",
                "keyword_id"=> 226,
        ...
        [
            "screen_id"=> "36",
            "screen_name"=> "DoctorProfileScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "36",
                "keyword_id"=> 234,
        ...
        [
            "screen_id"=> "41",
            "screen_name"=> "PendingQuestionsScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "41",
                "keyword_id"=> 282,
        ...
        [
            "screen_id"=> "43",
            "screen_name"=> "ImplantationCalculatorScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "43",
                "keyword_id"=> 288,
        ...
        [
            "screen_id"=> "44",
            "screen_name"=> "ShakingUpdateDialog",
            "keyword_data"=> [
            [
                "screen_id"=> "44",
                "keyword_id"=> 309,
        ...
        [
            "screen_id"=> "46",
            "screen_name"=> "GraphsAndReportScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "46",
                "keyword_id"=> 338,
        ...
        [
            "screen_id"=> "48",
            "screen_name"=> "PregnancyDetailScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "48",
                "keyword_id"=> 348,
        ...
        [
            ...
            [
                ...
                "keyword_value"=> "Water Drinking Reminder"
            ],
            [
                "screen_id"=> "51",
                "keyword_id"=> 368,
                "keyword_name"=> "weightLoggingReminders",
                "keyword_value"=> "Weight Logging Reminder"
            ],
            [
                "screen_id"=> "51",
                "keyword_id"=> 369,
                "keyword_name"=> "sleepReminders",
                "keyword_value"=> "Sleep Reminder"
            ],
            [
                "screen_id"=> "51",
                "keyword_id"=> 370,
                "keyword_name"=> "bodyTemperatureReminders",
                "keyword_value"=> "Body temperature Reminder"
            ],
            [
                "screen_id"=> "51",
                "keyword_id"=> 371,
        ...
        [
            "screen_id"=> "52",
            "screen_name"=> "EmailNewPinRequestDialog",
            "keyword_data"=> [
            [
                "screen_id"=> "52",
                "keyword_id"=> 377,
        ...
        [
            "screen_id"=> "53",
            "screen_name"=> "DoctorDashboardScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "53",
                "keyword_id"=> 405,
        ...
        [
            "screen_id"=> "56",
            "screen_name"=> "MenstrualReportScreen",
            "keyword_data"=> [
            [
                "screen_id"=> "56",
                "keyword_id"=> 586,
                "keyword_name"=> "HealthReport",
                "keyword_value"=> "Health Report"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 587,
                "keyword_name"=> "ExportedOn",
                "keyword_value"=> "Exported on:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 588,
                "keyword_name"=> "CyclePeriod",
                "keyword_value"=> "Cycle & Period length"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 589,
                "keyword_name"=> "AverageCycleLength",
                "keyword_value"=> "Average cycle length:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 590,
                "keyword_name"=> "AveragePeriodLength",
                "keyword_value"=> "Average period length:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 591,
            ...
            [
                "screen_id"=> "56",
                "keyword_id"=> 593,
                "keyword_name"=> "CycleRegularityScore",
                "keyword_value"=> "Cycle regularity score:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 594,
                "keyword_name"=> "PeriodRegularityScore",
                "keyword_value"=> "Period regularity score:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 595,
                "keyword_name"=> "Predictions",
                "keyword_value"=> "Predictions"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 596,
                "keyword_name"=> "NextPeriodDay",
                "keyword_value"=> "Next period day:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 597,
                "keyword_name"=> "NextOvulationDay",
                "keyword_value"=> "Next ovulation day:"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 598,
                "keyword_name"=> "SymptomPatternsSummary",
                "keyword_value"=> "Symptom Patterns Summary"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 599,
                "keyword_name"=> "Symptom",
                "keyword_value"=> "Symptom"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 600,
                "keyword_name"=> "Menstrual",
                "keyword_value"=> "Menstrual"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 601,
                "keyword_name"=> "Follicular",
                "keyword_value"=> "Follicular"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 602,
                "keyword_name"=> "Ovulation",
                "keyword_value"=> "Ovulation"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 603,
                "keyword_name"=> "Luteal",
                "keyword_value"=> "Luteal"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 604,
                "keyword_name"=> "NoSymptomPatternsAvailable",
                "keyword_value"=> "No symptom patterns available"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 605,
                "keyword_name"=> "ErrorLoadingReportData",
                "keyword_value"=> "Error loading report data"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 606,
                "keyword_name"=> "ReportDownloadedSuccessfully",
                "keyword_value"=> "Report downloaded successfully!"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 607,
            ...
            [
                ...
                "keyword_id"=> 608,
                "keyword_name"=> "MadeBy",
                "keyword_value"=> "Made By"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 609,
                "keyword_name"=> "application",
                "keyword_value"=> "Application"
            ],
            [
                "screen_id"=> "56",
                "keyword_id"=> 616,
                "keyword_name"=> "cycleHistorySummary",
                "keyword_value"=> "Cycle History Summary"
            ]
            ]
        ]
    ]
